// Perlin noise and blob displacement — по туториалу https://waelyasmina.net/articles/how-to-create-a-3d-audio-visualizer-using-three-js/
...
// Тот же шейдер для отрисовки точками + размер точки
